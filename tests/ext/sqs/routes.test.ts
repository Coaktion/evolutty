import { SNSQueueMessageTranslator, SNSQueueRouter, SQSClientOptions, SQSHandler, SQSMessageTranslator, SQSRouter } from '../../../src';
...
describe('SQSHandler', () => {
  describe('SQSRouter', () => {
    ...
    it('should return a router object', () => {
      ...
      expect(clientOptions.messageTranslator).toBeInstanceOf(SQSMessageTranslator);
    });
  });
  ...
  describe('SNSQueueRouter', () => {
    ...
    it('should return a router object', () => {
      ...
      expect(router).toBeDefined();
      expect(clientOptions.messageTranslator).toBeDefined();
      expect(clientOptions.messageTranslator).toBeInstanceOf(SNSQueueMessageTranslator);
    });
  });
});
